...
Используя интернет мной была найдена тема, наиболее похожая на альтернативный дизайн **TwentyFifteen**[https://demo.getgrav.org/twentyfifteen-skeleton/en]. На мой взгл]д это один из приблеженных вариантов к альтернативной версии сайта: слева боковое меню, справа основная страница сайта
